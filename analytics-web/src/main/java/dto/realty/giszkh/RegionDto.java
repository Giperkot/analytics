...
public class RegionDto {
    ...
    public String toString() {
        ...
        sb.append(RegionDto.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("guid");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RegionDto) == false) {
            return false;
        }
        RegionDto rhs = ((RegionDto) other);
