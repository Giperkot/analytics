...
public class ManagementOrganizationDto {
    ...
    private OlsonTZDto olsonTZ;
    @JsonProperty("okopf")
    private OkopfDto okopf;
    @JsonProperty("registryOrganizationRootEntityGuid")
    private String registryOrganizationRootEntityGuid;
    ...
    @JsonProperty("olsonTZ")
    public OlsonTZDto getOlsonTZ() {
        return olsonTZ;
    }

    @JsonProperty("olsonTZ")
    public void setOlsonTZ(OlsonTZDto olsonTZ) {
        this.olsonTZ = olsonTZ;
    }

    @JsonProperty("okopf")
    public OkopfDto getOkopf() {
        return okopf;
    }

    @JsonProperty("okopf")
    public void setOkopf(OkopfDto okopf) {
        this.okopf = okopf;
    }

    @JsonProperty("registryOrganizationRootEntityGuid")
    public String getRegistryOrganizationRootEntityGuid() {
        return registryOrganizationRootEntityGuid;
    }

    @JsonProperty("registryOrganizationRootEntityGuid")
    public void setRegistryOrganizationRootEntityGuid(String registryOrganizationRootEntityGuid) {
    ...
    public String toString() {
        ...
        sb.append(ManagementOrganizationDto.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("guid");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ManagementOrganizationDto) == false) {
            return false;
        }
        ManagementOrganizationDto rhs = ((ManagementOrganizationDto) other);
