...
public class ParentDto__3 {
    ...
    public String toString() {
        ...
        sb.append(ParentDto__3 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("guid");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ParentDto__3) == false) {
            return false;
        }
        ParentDto__3 rhs = ((ParentDto__3) other);
