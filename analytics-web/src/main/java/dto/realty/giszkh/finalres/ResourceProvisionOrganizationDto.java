...
public class ResourceProvisionOrganizationDto {
    ...
    @JsonProperty("olsonTZ")
    public OlsonTZDto__1 getOlsonTZ() {
        return olsonTZ;
    }

    @JsonProperty("olsonTZ")
    public void setOlsonTZ(OlsonTZDto__1 olsonTZ) {
    ...
    public String toString() {
        ...
        sb.append(ResourceProvisionOrganizationDto.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("guid");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ResourceProvisionOrganizationDto) == false) {
            return false;
        }
        ResourceProvisionOrganizationDto rhs = ((ResourceProvisionOrganizationDto) other);
