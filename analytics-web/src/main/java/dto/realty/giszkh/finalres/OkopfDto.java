...
public class OkopfDto {
    ...
    public String toString() {
        ...
        sb.append(OkopfDto.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("guid");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OkopfDto) == false) {
            return false;
        }
        OkopfDto rhs = ((OkopfDto) other);
