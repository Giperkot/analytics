...
public class ParentDto__1 {
    ...
    @JsonProperty("parent")
    public ParentDto__2 getParent() {
        return parent;
    }

    @JsonProperty("parent")
    public void setParent(ParentDto__2 parent) {
        this.parent = parent;
    }
    ...
    public String toString() {
        ...
        sb.append(ParentDto__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("guid");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ParentDto__1) == false) {
            return false;
        }
        ParentDto__1 rhs = ((ParentDto__1) other);
