...
public class HouseResponseDtoDto {
    ...
    @JsonProperty("oktmo")
    public OktmoDto__1 getOktmo() {
        return oktmo;
    }

    @JsonProperty("oktmo")
    public void setOktmo(OktmoDto__1 oktmo) {
        this.oktmo = oktmo;
    }
    ...
    @JsonProperty("actualHouseGuid")
    public String getActualHouseGuid() {
        return actualHouseGuid;
    }

    @JsonProperty("actualHouseGuid")
    public void setActualHouseGuid(String actualHouseGuid) {
    ...
    public String toString() {
        ...
        sb.append(HouseResponseDtoDto.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("guid");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof HouseResponseDtoDto) == false) {
            return false;
        }
        HouseResponseDtoDto rhs = ((HouseResponseDtoDto) other);
