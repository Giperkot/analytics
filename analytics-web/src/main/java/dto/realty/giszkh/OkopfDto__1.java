...
public class OkopfDto__1 {
    ...
    public String toString() {
        ...
        sb.append(OkopfDto__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("guid");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OkopfDto__1) == false) {
            return false;
        }
        OkopfDto__1 rhs = ((OkopfDto__1) other);
