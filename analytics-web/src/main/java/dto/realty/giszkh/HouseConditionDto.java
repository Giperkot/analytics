...
public class HouseConditionDto {
    ...
    public String toString() {
        ...
        sb.append(HouseConditionDto.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("guid");
        sb.append('=');
