...
public class OktmoDto {
    ...
    public String toString() {
        ...
        sb.append(OktmoDto.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("guid");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OktmoDto) == false) {
            return false;
        }
        OktmoDto rhs = ((OktmoDto) other);
