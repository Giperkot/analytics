...
public class HouseTypeDto {
    ...
    public String toString() {
        ...
        sb.append(HouseTypeDto.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("guid");
        sb.append('=');
        ...
        sb.append('=');
        sb.append(((this.houseTypeName == null)?"<null>":this.houseTypeName));
        sb.append(',');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.houseTypeName == null)? 0 :this.houseTypeName.hashCode()));
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof HouseTypeDto) == false) {
            return false;
        }
        HouseTypeDto rhs = ((HouseTypeDto) other);
        return (((((((((this.actual == rhs.actual)||((this.actual!= null)&&this.actual.equals(rhs.actual)))&&((this.code == rhs.code)||((this.code!= null)&&this.code.equals(rhs.code))))&&((this.lastUpdateDate == rhs.lastUpdateDate)||((this.lastUpdateDate!= null)&&this.lastUpdateDate.equals(rhs.lastUpdateDate))))&&((this.guid == rhs.guid)||((this.guid!= null)&&this.guid.equals(rhs.guid))))&&((this.houseTypeName == rhs.houseTypeName)||((this.houseTypeName!= null)&&this.houseTypeName.equals(rhs.houseTypeName))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.rootEntityGuid == rhs.rootEntityGuid)||((this.rootEntityGuid!= null)&&this.rootEntityGuid.equals(rhs.rootEntityGuid))))&&((this.createDate == rhs.createDate)||((this.createDate!= null)&&this.createDate.equals(rhs.createDate))));
    }
