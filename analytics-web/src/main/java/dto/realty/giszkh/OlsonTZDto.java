...
public class OlsonTZDto {
    ...
    public String toString() {
        ...
        sb.append(OlsonTZDto.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("guid");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OlsonTZDto) == false) {
            return false;
        }
        OlsonTZDto rhs = ((OlsonTZDto) other);
