...
public class OktmoDto__1 {
    ...
    public String toString() {
        ...
        sb.append(OktmoDto__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("classType");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OktmoDto__1) == false) {
            return false;
        }
        OktmoDto__1 rhs = ((OktmoDto__1) other);
