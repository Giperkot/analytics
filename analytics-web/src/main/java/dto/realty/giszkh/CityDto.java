...
public class CityDto {
    ...
    public String toString() {
        ...
        sb.append(CityDto.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("guid");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CityDto) == false) {
            return false;
        }
        CityDto rhs = ((CityDto) other);
