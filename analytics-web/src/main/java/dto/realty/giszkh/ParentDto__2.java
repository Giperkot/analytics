...
public class ParentDto__2 {
    ...
    @JsonProperty("parent")
    public ParentDto__3 getParent() {
        return parent;
    }

    @JsonProperty("parent")
    public void setParent(ParentDto__3 parent) {
        this.parent = parent;
    }
    ...
    public String toString() {
        ...
        sb.append(ParentDto__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("guid");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ParentDto__2) == false) {
            return false;
        }
        ParentDto__2 rhs = ((ParentDto__2) other);
