...
public class HouseInfoResponseDto {
    ...
    public String toString() {
        ...
        sb.append(
                HouseInfoResponseDto.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("total");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof HouseInfoResponseDto) == false) {
            return false;
        }
        HouseInfoResponseDto rhs = ((HouseInfoResponseDto) other);
