...
public class StreetResponseDtoDto {
    ...
    @JsonProperty("oktmo")
    public OktmoDto__2 getOktmo() {
        return oktmo;
    }

    @JsonProperty("oktmo")
    public void setOktmo(OktmoDto__2 oktmo) {
        this.oktmo = oktmo;
    }
    ...
    @JsonProperty("subjectCity")
    public Object getSubjectCity() {
        return subjectCity;
    }

    @JsonProperty("subjectCity")
    public void setSubjectCity(Object subjectCity) {
    ...
    public String toString() {
        ...
        sb.append(StreetResponseDtoDto.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("guid");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof StreetResponseDtoDto) == false) {
            return false;
        }
        StreetResponseDtoDto rhs = ((StreetResponseDtoDto) other);
