...
public class MetaDto__1 {
    ...
    public String toString() {
        ...
        sb.append(MetaDto__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MetaDto__1) == false) {
            return false;
        }
        MetaDto__1 rhs = ((MetaDto__1) other);
