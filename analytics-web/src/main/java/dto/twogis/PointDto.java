...
public class PointDto {
    ...
    public String toString() {
        ...
        sb.append(PointDto.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("lat");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PointDto) == false) {
            return false;
        }
        PointDto rhs = ((PointDto) other);
