...
public class NearestParkingDto {
    ...
    public String toString() {
        ...
        sb.append(NearestParkingDto.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NearestParkingDto) == false) {
            return false;
        }
        NearestParkingDto rhs = ((NearestParkingDto) other);
