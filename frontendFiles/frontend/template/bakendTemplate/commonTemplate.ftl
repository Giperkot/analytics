    ...
    <div class="footer">
        <div class="site_ar flex">
            <div class="bottomm_company">
                ...
                <ul>
                    <li><div><a href="/import">Импорт</a></div></li>
                    <li><div><a href="/realtySearch">Недвижимость. Квартиры</a></div></li>
                </ul>
            </div>
...
<div class="menu_wrapper">
    ...
    <div class="menu_inner menu_inner__fil_space">
        <div class="menu_inner__content">
            <div class="menu_item" data-link="/import" data-cmp="cabinetOptions">
            ...
            <div class="menu_item" data-link="/realtySearch/" data-cmp="specializationListMain">
